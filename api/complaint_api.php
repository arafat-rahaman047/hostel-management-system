...
// Fetch complaints with assigned tutor name
if ($student_id) {
    $cq = $conn->prepare("
        SELECT 
            c.complaint_id,
        ...
        FROM Complaints c
        LEFT JOIN Users u ON c.tutor_id = u.user_id
        WHERE c.student_id = ?
...
<div class="container py-4">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-md-3">
            <div class="card text-center border py-3" style="border-left: 3px solid #dc3545 !important;">
                    ...
                    <table class="table table-sm table-hover align-middle mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-muted small fw-semibold" style="width:115px;">Assigned To</th>
                            ...
                            <td>
                                <?php if ($c['tutor_name']): ?>
                                    <span class="small text-primary">
                                        <i class="fas fa-user-tie me-1"></i><?php echo htmlspecialchars($c['tutor_name']); ?>
                                    </span>
                                <?php else: ?>
