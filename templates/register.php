...
<div class="container d-flex justify-content-center align-items-center py-5" style="min-height: 90vh;">
    <div class="card shadow-lg border-0" style="max-width: 500px; width: 100%; border-radius: 15px;">
        ...
        <div class="card-header text-center bg-white pt-4 border-0">
            ...
            <h4 class="fw-bold mt-3 text-primary">Student Registration</h4>
            <p class="text-muted small">Join the University of Barishal Hostel Management System</p>
        </div>
        ...
        <div class="card-body px-4 pb-4">
            ...
            <form action="../api/register_api.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="name"
                               ...
                               placeholder="e.g. Arafat Rahaman" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email"
                               class="form-control border-start-0 ps-0 bg-light"
                               placeholder="e.g. arahaman@bu.ac.bd" required>
                    </div>
                </div>
                ...
                <div class="alert alert-primary py-2 small text-center mb-4">
                    <i class="fas fa-user-graduate me-1"></i>
                    You are registering as a <strong>Student</strong>.
                    Staff accounts are created by the Admin Office.
                </div>
