...
<div class="container py-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h3 class="fw-bold mb-0"><i class="fas fa-file-invoice-dollar text-success me-2"></i>Hall Payment Portal</h3>
            <p class="text-muted small mb-0"><?php echo htmlspecialchars($student['hostel_name'] ?? 'No Hostel Assigned'); ?></p>
        </div>
        <?php if ($student_id): ?>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-<?php echo $badge; ?> px-3 py-2"><?php echo $p['status']; ?></span>
                                <?php if ($p['status'] === 'Verified' && $p['verified_by_name']): ?>
                                    <br><small class="text-muted">by <?php echo htmlspecialchars($p['verified_by_name']); ?></small>
                                <?php endif; ?>
                            </td>
            ...
            <form action="../api/payment_api.php" method="POST">
                <div class="modal-body p-4">
                    ...
                    <div class="alert alert-info small">
                        ...
                        Pay via bKash/Nagad to <strong>01XXXXXXXXX</strong>, then submit the transaction ID here for verification.
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="amount" class="form-control" step="0.01" min="1" required placeholder="e.g. 3000">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="transaction_id" class="form-control" required placeholder="e.g. 8N7KD3Q2L1">
                        </div>
                        <div class="col-12">
...
<div class="position-fixed bottom-0 end-0 p-3" style="z-index:9999">
    <div class="toast show bg-success text-white border-0 shadow">
        <div class="toast-body"><i class="fas fa-check-circle me-2"></i>Payment submitted successfully! Awaiting verification.</div>
    </div>
</div>
<?php elseif (isset($_GET['error'])): ?>
<div class="position-fixed bottom-0 end-0 p-3" style="z-index:9999">
    <div class="toast show bg-danger text-white border-0 shadow">
        <div class="toast-body"><i class="fas fa-times-circle me-2"></i><?php echo htmlspecialchars($_GET['error']); ?></div>
    </div>
</div>
<?php endif; ?>
